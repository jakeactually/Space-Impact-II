...
FILE* GetLevel(Uint8 Level) {
    char Path[22 /* Mappa */ + 3 /* Maximum háromjegyű azonosító */ + 1 /* Lezáró nulla */] = "data/levels/"; /* A beolvasandó fájl elérési útvonala, fájlnév nélkül */
...
Enemy GetEnemy(Uint8 ID) {
    if (!Enemies[ID]) { /* Ha még nincs betöltve */
        ...
        char Path[23 /* Mappa */ + 3 /* Maximum háromjegyű azonosító */ + 1 /* Lezáró nulla */] = "data/enemies/"; /* A beolvasandó fájl elérési útvonala, fájlnév nélkül */
