...
SDL_Renderer* SDL_StartSurface(Vec2 FrameSize) { /* SDL inicializálása adott képméretre */
    SDL_Window* sdlWindow;
    SDL_Renderer* s;
    SDL_Init(SDL_INIT_VIDEO | SDL_INIT_AUDIO | SDL_INIT_TIMER); /* Kép, hang, és időzítő is kell */
    SDL_CreateWindowAndRenderer(FrameSize.x, FrameSize.y, SDL_WINDOW_OPENGL, &sdlWindow, &s); /* Ablakméret átadása SDL-nek */
...
int main(int argc, char *argv[]) {
    ...
    SDL_Event e;
    SDL_Renderer* s = SDL_StartSurface(FrameSize);
    ...
    while (run) {
        ...
        case SDL_USEREVENT:
            ...
            /** Játék vége képernyõ **/
                ...
                _itoa(Player.Score, ScoreText, 10); /* Pontszám szöveggé alakítása */
            ...
            /** Rekodrképernyõ **/
                ...
                char ScoreText[6]; /* Maximum ötjegyű lehet + lezáró karakter */
                _itoa(TopScores[0], ScoreText, 10); /* Pontszám szöveggé alakítása */
